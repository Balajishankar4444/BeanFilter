...
const SUBSCRIPTION_PROVIDERS: SubscriptionProvider[] = [
  ...
  {
    id: 'volcanica-coffee',
    name: 'Volcanica Coffee Subscription',
    ...
    description: 'Freshly roasted single-origin volcanic coffees from Jamaica Blue Mountain, Kona, Ethiopia, and Central America with automatic subscription discounts.',
    highlights: ['130+ Single-Origin Volcanic Coffees', 'Freshly roasted on order date', '10% recurring subscription savings', 'Free US shipping over $40'],
    bestFor: 'Best for Exotic Single-Origin Enthusiasts',
  },
  {
    id: 'lifeboost-coffee',
    name: 'Lifeboost Organic Subscription',
    ...
    description: 'Single-origin, shade-grown, 3rd-party lab tested organic low-acid coffee gentle on digestion.',
    highlights: ['3rd-Party Lab Tested for Mycotoxins', 'Shade-grown single-origin Arabica', 'Stomach-friendly low acidity', 'Recurring 15% subscriber discount'],
    bestFor: 'Best for Stomach-Friendly Organic Coffee',
  },
  {
    id: 'fresh-roasted-coffee',
    name: 'Fresh Roasted Coffee Club',
    ...
    description: 'Eco-friendly smokeless-roasted single-origin coffees and organic Fair Trade blends delivered on your custom schedule.',
    highlights: ['Smokeless Loring roasting technology', 'Fair Trade & Organic certified options', 'Customizable delivery frequency', 'Unbeatable price per bag'],
    bestFor: 'Best Value Specialty Subscription',
  },
  {
    id: 'origin-coffee',
    name: 'Origin Coffee Roasters Subscription',
    ...
    description: 'Direct-trade specialty single-origins and seasonal espresso roasts curated by UK Barista Champions.',
    highlights: ['Curated by UK Barista Champions', 'Direct-trade farm partnerships', 'Fully compostable coffee bags', 'Free UK subscriber delivery'],
    bestFor: 'Best UK Artisanal Single-Origins',
  },
  {
    id: 'blue-tokai',
    name: 'Blue Tokai Coffee Subscription',
    ...
    description: 'Freshly roasted Indian estate single-origins sourced directly from high-elevation Western Ghats coffee farms.',
    highlights: ['Direct-trade Indian estate farms', 'Custom roast date stamping', 'Custom grind selection per order', 'Flexible delivery intervals'],
    bestFor: 'Best for Indian Estate Coffee Lovers',
  },
];
